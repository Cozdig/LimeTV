...
class Program(models.Model):
    ...
    program_id = models.CharField(max_length=50, unique=True, verbose_name="id программы")
    ...
    sub_title = models.CharField(max_length=400, null=True, verbose_name="серия, название серии")
